...
int SGeneralConsts::SCOUT_FREE_POINT = 300;// scout goes to a point if there are no ours within this radius from it
int SGeneralConsts::SCOUT_POINTS = 4;
NTimer::STime SGeneralConsts::TIME_SONT_SEE_AA_BEFORE_FORGET = 180000;// relate to aircraft regeneration time
