...
// **********************************************************************
// //////////////////////////////////////////////////////////// 
CPtr<CInTransportStatesFactory> CInTransportStatesFactory::pFactory = nullptr;

IStatesFactory *CInTransportStatesFactory::Instance()
{
  if (pFactory == nullptr) pFactory = new CInTransportStatesFactory();
...
{
  NI_ASSERT_T(dynamic_cast<CSoldier*>( pUnit ) != 0, "Wrong unit type");
  return CSoldierRestOnBoardState::Instance(static_cast<CSoldier *>(pUnit), nullptr);
}
...
// **********************************************************************
// //////////////////////////////////////////////////////////// 
IUnitState *CSoldierRestOnBoardState::Instance(CSoldier *pSoldier, CMilitaryCar *pTransport) { return new CSoldierRestOnBoardState(pSoldier, pTransport); }
// //////////////////////////////////////////////////////////// 
CSoldierRestOnBoardState::CSoldierRestOnBoardState(CSoldier *_pSoldier, CMilitaryCar *pTransport)
  : pSoldier(_pSoldier)
{
  // if not already inside the transport
