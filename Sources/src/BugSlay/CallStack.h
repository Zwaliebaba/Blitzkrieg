...
struct SCallStackEntry
{
  ...
  DWORD params[4];// possible function parameters
};

using CCallStackEntryList = std::list<SCallStackEntry>;
// ignores
constexpr DWORD IGNORE_THIS = 0x00000001;
constexpr DWORD IGNORE_NON_THIS = 0x00000002;
constexpr DWORD IGNORE_FILE = 0x00000004;
constexpr DWORD IGNORE_NON_FILE = 0x00000008;
constexpr DWORD IGNORE_ALL = 0x00000010;
constexpr DWORD IGNORE_LOG = 0x00000020;
...
using SIgnoresList = std::list<SIgnoresEntry>;
