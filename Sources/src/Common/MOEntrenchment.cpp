...
// visiting
void CMOEntrenchmentSegment::Visit(IMapObjVisitor *pVisitor) { pVisitor->VisitMesh(pVisObj, pDesc->eGameType, pDesc->eVisType); }
...
void CMOEntrenchmentSegment::SetPlacement(const CVec3 &vPos, const WORD &wDir) { pVisObj->SetPlacement(vPos, wDir); }
