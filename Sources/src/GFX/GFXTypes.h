...
// basic structure for the light source
...
// directional continuous light source (aka Directional Light)
struct SGFXLightDirectional : SGFXLightBase
{
  CVec3 vDir;// direction that the light is pointing in world space
};

// point light source (aka Point Light)
struct SGFXLightPoint : SGFXLightBase
{
...
// cone-shaped light source (aka Spot Light)
struct SGFXLightSpot : SGFXLightPoint
{
  CVec3 vDir;// direction that the light is pointing in world space
