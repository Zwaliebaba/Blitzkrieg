...
// with a new nick to retry.  
// disconnected with chatDisconnect.  
// the chatConnectCallback will get called.  
...
typedef void (*chatGetUserInfoCallback)(CHAT chat,
                                        CHATBool success,
                                        const char *nick,// PANTS|14/02/2000|added nick and user
                                        const char *user,
                                        const char *name,
                                        const char *address,
                                        int numChannels,
