    ...
    case UI_NOTIFY_WINDOW_CLICKED:
      ...
      switch (m_nType)
      {
        ...
        case E_MESSAGE_BOX_TYPE_OKCANCEL:
          if (msg.nFirst == 1) m_nResult = E_MESSAGE_BOX_RETURN_OK;
          else m_nResult = E_MESSAGE_BOX_RETURN_CANCEL;
          break;

        case E_MESSAGE_BOX_TYPE_YESNO:
          if (msg.nFirst == 1) m_nResult = E_MESSAGE_BOX_RETURN_YES;
          else m_nResult = E_MESSAGE_BOX_RETURN_NO;
          break;
      }
